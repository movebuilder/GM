...
class GMTextField extends StatefulWidget {
  final String text;
  final double? width;
  final double? height;
  ...
  @override
  _GMTextFieldState createState() => _GMTextFieldState();
}

class _GMTextFieldState extends State<GMTextField> with WidgetsBindingObserver {
  ...
  @override
  void didUpdateWidget(covariant GMTextField oldWidget) {
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SvgPicture.asset(
                        "assets/svgs/icon_clear_input.svg",
                        width: 16.w,
                        height: 16.w,
                      ),
                    ],
